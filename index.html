	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<p class="phone-info">Call me qq: <a href="#">3513805092</a></p>
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12">
...
<div class="visible-xs visible-sm responsive-menu">
	...
	<div class="show-menu">
		<ul class="main-menu">
			...
			<li>
				<a class="show-3 projectbutton" href="#"><i class="fa fa-camera"></i>展示</a>
			</li>
			<li>
				<a class="show-5 contactbutton" href="#"><i class="fa fa-envelope"></i>联系</a>
			</li>
		</ul>
	</div>
</div>
		...
		<div class="col-md-9 col-sm-12 content-holder">
			...
			<div id="menu-container">
				...
				<div class="logo-holder logo-top-margin">
					<a href="#" class="site-brand"><img src="images/logo.png" height="50" width="50" alt=""></a>
				</div>
				
				
				<div id="menu-1" class="homepage home-section text-center">
					<div class="welcome-text">
						<h2>记录生活 ，<strong>留存回忆</strong></h2>
						<p> <span>我从夜里醒来，望向窗外</span><span>在这楼房环绕的城市里</span>独自徘徊，我从夜里醒来，从梦里逃出来，只有风吹动的声音，全世界只有我自己清醒。</p>
						<form action="#" method="get" class="subscribe-form">
							<div class="row">
								<fieldset class="col-md-offset-2 col-md-6">
									<input name="subscribe-email" type="email" class="email" id="subscribe-email" placeholder="请输入你的邮箱...">
								</fieldset>
								<fieldset class="col-md-4 button-holder">
									<input name="submit" type="submit" class="button default" id="submit" value="Submit">
								</fieldset>
							</div>
							<p class="subscribe-text">或许我本该属于这大海，从来不属于如影随形的一种存在</p>
						</form>
					</div>
				</div>
				...
				<div id="menu-2" class="content about-section">
					<div class="row">
						<div class="col-md-8 col-sm-8">
							<div class="box-content profile">
								<h3 class="widget-title">关于我最近听的歌</h3>
								<div class="profile-thumb">
									<img src="images/8.jpg" alt="">
								</div>
								<div class="profile-content">
									<h5 class="profile-name">鲸鱼</h5>
									<span class="profile-role">尚士达</span>
									<p>挺好听的还，<a rel="nofollow" href="#">https://music.163.com/#/song?id=1362281761a> 先就这样。<br><br>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-5 col-sm-5">
							<div class="box-content">
								<h3 class="widget-title">Just For Fun</h3>
						...
						<div class="col-md-7 col-sm-7">
							<div class="box-content">
								<h3 class="widget-title">My Technical Skills</h3>
				...
				<div id="menu-3" class="content gallery-section">
					<div class="box-content">
						<h3 class="widget-title">好看的图片</h3>
						<div class="row">
